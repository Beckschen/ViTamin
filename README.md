...
🔥 ViTamin sets a new SOTA across seven benchmarks for open-vocabulary segmentation, and significantly pushing forward the capabilities of large multi-modal models.
