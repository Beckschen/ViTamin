...
def get_wds_dataset(args, preprocess_img, is_train, epoch=0, floor=False, tokenizer=None):
    ...
    pipeline.extend([
        ...
        wds.map_dict(image=preprocess_img, text=lambda text: tokenizer(text)[0], score=lambda score: score['clip_l14_similarity_score']), # wds.map_dict(image=preprocess_img, text=lambda text: tokenizer(text)[0]),
        wds.to_tuple("image", "text", "score"),
